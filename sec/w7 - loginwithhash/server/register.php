<html>
	...
	<body>
		<?php
			...
			if($exist == 1){
				echo "<h3>Error: Input Invalid/Exist.<br/><br/>Try again <a href='../client/register.html'>here</a>.</h3>";
			}else{
				...
				//close the "$file"
				fclose($file);
				echo "<h3>Registration success!<br/><br/>Try again <a href='../client/register.html'>here</a>.</h3>";
			}
		?>
	</body>
</html>
